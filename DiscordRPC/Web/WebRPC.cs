...
namespace DiscordRPC.Web
{
    ...
    /// </summary>
    [System.Obsolete("Rich Presence over HTTP is no longer supported by Discord. See official Rich Presence github for more information.")]
    public static class WebRPC
    {
        ...
        /// <summary>
        /// Attempts to set the Rich Presence over the HTTP protocol. Does not support Join / Spectate and by default is blocking.
        /// </summary>
        /// <param name="presence">The presence to send to discord</param>
        ...
        public static bool TrySetRichPresence(RichPresence presence, out RichPresence response, string applicationID, int port = 6463)
        {
            ...
            if (presence != null)
            {
                ...
                if (presence.HasSecrets())
                    throw new BadPresenceException("Cannot send a presence with secrets as HTTP endpoint does not support events.");
            ...
            // Iterate over the ports until the first successful one
        ...
        /// <summary>
        /// Prepares a struct containing data required to make a successful web client request to set the rich presence.
        /// </summary>
        ...
        /// <returns>Returns a web request containing necessary data to make a POST request</returns>
        [System.Obsolete("WebRequests are no longer supported because of the removed HTTP functionality by Discord. See official Rich Presence github for more information.")]
    ...
    /// </summary>
    [System.Obsolete("Web Requests is no longer supported as Discord removed HTTP Rich Presence support. See official Rich Presence github for more information.")]
